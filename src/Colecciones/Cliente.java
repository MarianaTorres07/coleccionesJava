...
public class Cliente {
	...
	public void mostrarInfoCliente() {
		...
		System.out.println("La cuenta bancaria " +  cuentaBancaria);
 ...
 * 
 * Tiene que ver con la forma en como ocultamos algunos detalles de nuestra clase (atributos y metodos). La gran venta de hacer esto es que podemos proteger los datos y el comportamiento de una clase. Cuando utilizamos los modificadores de acceso, podemos controlar la forma en como se accede a los datos y como interactuamos con ellos.
 * 
 *   
 ...
 *   -private
 *   -protected
 *   -dafault (sin modificador de acceso)
 *   
 * 
 ...
 *   Jesus.saldo = no se muestra porque a informacion esta privada
 *   
 *   
